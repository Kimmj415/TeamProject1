    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String title = filterProfanity(editTextTitle.getText().toString().trim());
                String content = filterProfanity(editTextContent.getText().toString().trim());
                            ...
                            db.collection(collectionPath).document(documentId)
                                    ...
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if (task.isSuccessful()) {
                                                // 데이터 추가 성공
                                                Intent next = new Intent(new Intent(NewPostActivity.this, SubBoardActivity.class));
