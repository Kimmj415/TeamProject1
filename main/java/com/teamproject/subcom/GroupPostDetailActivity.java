...
public class GroupPostDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        introTextView=findViewById(R.id.intro_tv);
        urlTextView=findViewById(R.id.url_tv);
        ...
        db.collection("게시판")
                ...
                .addSnapshotListener(new EventListener<QuerySnapshot>() {
                    ...
                    public void onEvent(@Nullable QuerySnapshot queryDocumentSnapshots, @Nullable FirebaseFirestoreException e) {
                        ...
                        CommentAdapter commentAdapter = new CommentAdapter(comments,GroupPostDetailActivity.this);
            ...
            if (!comment.isEmpty()) {
                ...
                db.collection("게시판")
                        ...
                        .addOnSuccessListener(documentReference -> {
                            // 댓글 추가 성공 시 처리
                            Toast.makeText(GroupPostDetailActivity.this, "댓글이 추가되었습니다.", Toast.LENGTH_SHORT).show();
                            commentEditText.setText("");
                            Intent intent = new Intent(GroupPostDetailActivity.this, PostDetailActivity.class);
                        ...
                        .addOnFailureListener(e -> {
                            // 댓글 추가 실패 시 처리
                            Toast.makeText(GroupPostDetailActivity.this, "댓글 추가 실패.", Toast.LENGTH_SHORT).show();
                        });
            } else {
                Toast.makeText(GroupPostDetailActivity.this, "댓글 내용을 입력하세요.", Toast.LENGTH_SHORT).show();
            }
        });
                        ...
                        if (task.isSuccessful()) {
                            ...
                            if (querySnapshot != null && !querySnapshot.isEmpty()) {
                                ...
                                if (post != null) {
                                    ...
                                    String[] parts=post.getContents().toString().split("\n");
                                    introTextView.setText(parts[0]);
                                    urlTextView.setText(parts[3]);
                                    contentTextView.setText(parts[1]+"\n\n우대사항: "+parts[2]);
                                }
                            } else {
                                Toast.makeText(GroupPostDetailActivity.this, "일치하는 게시물 없음", Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Toast.makeText(GroupPostDetailActivity.this, "데이터 로딩 실패.", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
